...
function main(config) {
  ...
  config["proxy-groups"] = [
    ...
    },
    {
      ...
      "name": "Proxy",
      "type": "select",
      "proxies": ["HongKong", "TaiWan", "Japan", "Singapore", "America", "Russia", "AllServer", "DIRECT"],
    ...
    },
    {
      ...
      "name": "AI",
      "type": "select",
      "proxies": ["Proxy", "HongKong", "TaiWan", "Japan", "Singapore", "America", "Russia", "AllServer"],
    ...
    },
    {
      ...
      "name": "Emby",
      "type": "select",
      "proxies": ["Proxy", "HongKong", "TaiWan", "Japan", "Singapore", "America", "Russia", "AllServer", "DIRECT"],
    ...
    // 新增俄罗斯地区分组
    {
      ...
      "lazy": true,
      "include-all": true,
      "filter": "(?i)🇷🇺|俄罗斯|莫斯科|(\b(RU|Russia)\b)",
